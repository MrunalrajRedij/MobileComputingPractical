...
public class To_Do_List extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemLongClickListener{
    ...
    public void onClick(View view) {
        ...
        {
            values.add(add_item);
            adapter=new ArrayAdapter<String>(To_Do_List.this,android.R.layout.simple_list_item_1,values);
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(To_Do_List.this); // Ask the user to get the confirmation before deleting an item from the listView
